    ...
    <div className='container skills-container' id='skills'>
      <div className='skill-container-left'>
        ...
        <div className='skill-subHeading'>
          <p>
            Hi, I'm Prajapati Apurva, currently pursuing a degree in Computer Science and
            Engineering at Parul University, in my 3rd year. I possess
            skills in problem-solving, teaching, and I'm a learning Full Stack Web
            Developer.
          </p>
        </div>
      </div>
